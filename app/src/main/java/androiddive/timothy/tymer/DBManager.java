...
public class DBManager {
    ...
    public void insert(String name, String len,String sound) {
    ...
    public Cursor fetch() {
        String[] columns = new String[] {DatabaseHelper._ID, DatabaseHelper.TYMER_NAME, DatabaseHelper.TYMER_LEN,DatabaseHelper.TYMER_SOUND};
    ...
    public int update(long _id, String name, String len,String sound) {
